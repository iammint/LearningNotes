...
## 3. Loaders
> A **loader** is a piece of code that webpack will run on your code before it gets bundled. Loaders are used to transform other resources into javascript. **Loaders** are also npm packages.
...
- The `use` property is an array of loaders which will be used to transform the files. Loaders are also npm packages. 
